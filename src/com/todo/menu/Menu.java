...
public class Menu {
    ...
    private static void displaymenu()
    {
        ...
        System.out.println("6. 아이템 리스트 보기 ( ls )");
        System.out.println("7. 아이템 리스트 이름 정렬 ( ls_name_asc )");
        System.out.println("8. 아이템 리스트 이름 역순 정렬 ( ls_name_desc )");
        System.out.println("9. 아이템 리스트 날짜 정렬 ( ls_date )");
        System.out.println("10. 아이템 리스트 날짜 역순 정렬 ( ls_date_desc )");
